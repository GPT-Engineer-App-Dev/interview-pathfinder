...
**Project**: interview-pathfinder 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: In your initial prompt, provide this exact description, copied verbatim.
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/interview-pathfinder.git
cd interview-pathfinder
npm i
